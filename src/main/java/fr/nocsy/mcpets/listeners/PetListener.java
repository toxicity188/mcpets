...
public class PetListener implements Listener {
    ...
    public void despawnOnDismount(ModelDismountEvent e)
    {
        ...
        if(vehicle == null || vehicle.getModeledEntity().getBase() == null)
            return;
        ...
        new BukkitRunnable() {
            @Override
            public void run() {
                Pet pet = Pet.getFromEntity(Bukkit.getEntity(vehicle.getModeledEntity().getBase().getUUID()));
    ...
    public void mountingPet(ModelMountEvent e)
    {
        ...
        if(e.getVehicle() == null || e.getVehicle().getModeledEntity().getBase() == null)
            return;
